...
<div class='authentificated FontInter'>
    ...
    <div class="text-image-container">
        ...
        <div class="item">
            <svg class="pointer" width="25" height="25" id='notification' viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg class="pointer" width="23" height="23" id="logout" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class='input-container blackInter'>
        ...
        <button class="pointer" id='boutique' type='submit'>Visiter la boutique</button>
    </div>
    ...
    <div class="centre">
        ...
        <div id="participation">
            ...
            <div id="container-participation">
                <div class="entete">
                    <h1>{{$participation[1]->name}}</h1>
                    <p>{{$participation[1]->start_time}}</p>
                </div>
                <div class="row">
                    <div class="description">
                        <h2>{{$participation[1]->name}}</h2>
